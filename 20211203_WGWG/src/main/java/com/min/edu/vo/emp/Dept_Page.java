...
Logger logger = LoggerFactory.getLogger(this.getClass());
	...
	public Dept_Page(String index, String pageStartNum, String listCnt, String searchWord) {
	...
	public Dept_Page(int pageCnt, int index, int pageStartNum, int listCnt, int total, String searchBy,
			String searchWord) {
		super();
