...
//session에 websocketsession을 담아서 실시간 알림 같은 것도 할 수 있음
// map 으로 {session:websocketSession} 담으면 됨,,

// bean으로 만들기
// servlet-context.xml의 <websocket:mapping handler="wsChat.do" 이름과 동일하게 value 줌
