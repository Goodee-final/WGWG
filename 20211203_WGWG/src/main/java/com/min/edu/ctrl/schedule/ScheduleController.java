...
public class ScheduleController {
	...
	@ResponseBody
	public String save(ScheduleVO vo,int emp_no, String title,String start, String end,String textColor,String backgroundColor,String description) throws ParseException, java.text.ParseException {
		
		// String s = start.substring(10, start.length()-2); 
		//String e = end.substring(10, end.length()-2);
		...
		int cnt = service.insertScheduleP(vo);
