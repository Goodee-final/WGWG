...
<body>
	...
	<div style="margin-left: 18%">
		<div>
			...
			<div style="background: url('images/signature.png'); width: 300px; height: 300px;"></div>
			<div style="background: url('/20211203_WGWG/src/main/webapp/img/sponge.png'); width: 300px; height: 300px;"></div>
