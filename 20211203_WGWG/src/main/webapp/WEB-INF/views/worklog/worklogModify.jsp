...
<body>
	...
	<div class="container">
	<h1>업무일지 수정 화면</h1>
		<form action="./worklogModify.do" method="post">
			<input type="hidden" id="emp_no" name="emp_no" value="${vo.emp_no}">
			<input type="hidden" id="worklog_no" name="worklog_no" value="${vo.worklog_no}">
			<div class="wrap">
				<br>
				<div class="writer">
					수정일은 등록하기 버튼을 누르면 자동으로 등록됩니다.
				</div>
				<div class="fgroup">
					<br>
					<div class="writer">
