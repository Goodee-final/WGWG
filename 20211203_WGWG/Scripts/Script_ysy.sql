...
-- DELFLAG 컬럼 추가
ALTER TABLE "C##WG".WORKLOG ADD WORKLOG_DELFLAG VARCHAR2(10);
...
SELECT w.*, e.EMP_NM, d.DEPT_NM 
	...
	LEFT JOIN DEPARTMENT d 
	ON e.DEPT_NO = d.DEPT_NO
	WHERE w.WORKLOG_CONTENT LIKE '%업무%' 
	OR e.EMP_NM LIKE '%업무%';

--

INSERT INTO WORKLOG
(WORKLOG_NO, WORKLOG_REG_DT, WORKLOG_MODIFY_DT, WORKLOG_CONTENT, EMP_NO, WORKLOG_DELFLAG)
VALUES(7, SYSDATE, '', '신업무일지', 5, 'N');

UPDATE WORKLOG
SET WORKLOG_REG_DT='', WORKLOG_MODIFY_DT='', WORKLOG_CONTENT='', EMP_NO=0, WORKLOG_DELFLAG=''
WHERE WORKLOG_NO=0;
-------
--업무일지 내용 수정
UPDATE WORKLOG
SET WORKLOG_MODIFY_DT=SYSDATE, WORKLOG_CONTENT='신업무일지양식 업데이트' WORKLOG_DELFLAG='N'
WHERE WORKLOG_NO=7;
--업무일지 DELFLAG 'Y' 로 변경
UPDATE WORKLOG
