...
INSERT INTO EMP
(EMP_NO, EMP_NM, PW, EMAIL, PHOTO, ADDRESS, TEL, HIREDATE, WORK_ST, POSITION_NO, DEPT_NO)
...
(HISTORY_NO, CHANGE_DT, DEPT_NO)
VALUES(1, '2021-12-03', 20);

INSERT INTO DEPT_HISTORY
(HISTORY_NO, CHANGE_DT, DEPT_NO)
VALUES(2, '2021-11-05', 30);
...
(EMP_NO, WORK_LOG)
VALUES(1, '"1": [
    {"st": "2021-12-02 09:00:00", "ed": "2021-12-02 18:00:00"},
    {"st": "2021-12-03 09:00:00", "ed": "2021-12-03 18:00:00"}]');
INSERT INTO WORK_RECORD
(EMP_NO, WORK_LOG)
VALUES(2, '"2": [
    {"st": "2021-12-02 09:00:00", "ed": "2021-12-02 18:00:00"},
...
-----------------------------------개인 일정관리 insert
INSERT INTO SCHEDULESCHEDULESCHEDULE
   ...
   VALUES(1, '제목2', '내용2', SYSDATE-1, SYSDATE, 'true', '글자색1', '배경색1', 'P', 5);
-----------------------------------회사 일정관리 insert-------------------------------
...
VALUES(1, '{"APPROVER":[{"EMP_NO":"1", "APPROVAL_ST":"진행", "REASON":"", "APPROVAL_DT":"'||to_char(CURRENT_TIMESTAMP, 'yyyy/mm/dd HH:MI')||'"},
...
INSERT INTO APPROVAL_LINE
(APP_LINE_NO, APPROVER, BOOKMARK)
VALUES(2, '{"APPROVER": [{"EMP_NO": "3", "APPROVAL_ST": "진행", "REASON":"", "APPROVAL_DT": "'||to_char(CURRENT_TIMESTAMP, 'yyyy/mm/dd HH:MI')||'"},
