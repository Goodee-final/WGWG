...
SELECT sign_no, emp_no, TO_CHAR(sign_reg_dt,'yyyy-mm-dd') sign_reg_dt, TO_CHAR(sign_exp_dt, 'yyyy-mm-dd') sign_exp_dt , sign_img, sign_img_size FROM SIGN s WHERE emp_no = 1 ORDER BY sign_no;
