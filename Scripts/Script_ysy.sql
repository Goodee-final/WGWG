...
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-01 01:01:01','YYYY-MM-DD HH24:MI:SS'), 1);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-02 02:02:02','YYYY-MM-DD HH24:MI:SS'), 2);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-03 04:04:04','YYYY-MM-DD HH24:MI:SS'), 3);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-02 02:02:02','YYYY-MM-DD HH24:MI:SS'), 4);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-03 04:04:04','YYYY-MM-DD HH24:MI:SS'), 5);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-02 03:03:03','YYYY-MM-DD HH24:MI:SS'), 6);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-03 05:05:05','YYYY-MM-DD HH24:MI:SS'), 7);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-03 03:03:03','YYYY-MM-DD HH24:MI:SS'), 8);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-04 05:05:05','YYYY-MM-DD HH24:MI:SS'), 9);


INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'N', TO_DATE('2021-11-01 01:01:01','YYYY-MM-DD HH24:MI:SS'), 10);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-02 03:03:03','YYYY-MM-DD HH24:MI:SS'), 10);
INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'Y', TO_DATE('2021-11-03 05:05:05','YYYY-MM-DD HH24:MI:SS'), 10);

INSERT INTO CHAT_MEMBER
(MEM_NO, CHAT_MEMBER_ST, CHAT_MEMBER_JOIN_DT, EMP_NO)
VALUES(CHAT_MEMBER_SEQ.NEXTVAL, 'N', TO_DATE('2021-11-05 05:05:05','YYYY-MM-DD HH24:MI:SS'), 10);
...
INSERT INTO CHAT_ROOM
(CHAT_ROOM_NO, CHAT_ROOM_NM, CHAT_ROOM_REG_DT, CHAT_MEMBERS)
VALUES(CHAT_ROOM_SEQ.NEXTVAL, '룸3', TO_DATE('2021-11-02 03:03:03','YYYY-MM-DD HH24:MI:SS'), '6,8,11');
INSERT INTO CHAT_ROOM
(CHAT_ROOM_NO, CHAT_ROOM_NM, CHAT_ROOM_REG_DT, CHAT_MEMBERS)
...
ALTER TABLE "C##WG".WORKLOG ADD WORKLOG_TITLE VARCHAR2(200) DEFAULT '주간업무일지';
--CREATE TABLE "C##WG".WORKLOG (
--	WORKLOG_NO NUMBER(16) PRIMARY KEY,
--	WORKLOG_REG_DT DATE DEFAULT SYSDATE,
--	WORKLOG_MODIFY_DT DATE,
